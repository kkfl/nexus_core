...
async def get_secret(alias: str, tenant_id: str, env: str, correlation_id: str) -> str | None:
    headers = {
    ...
    try:
        async with httpx.AsyncClient(timeout=3.0) as client:
            ...
            logger.warning(
                "secret_not_found_or_access_denied", alias=alias, tenant_id=tenant_id, env=env
            )
            return None
