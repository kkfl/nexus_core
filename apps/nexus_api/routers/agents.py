...
from packages.shared.schemas.core import AgentCreate, AgentOut, AgentUpdate, AgentCheckinCreate, AgentCheckinOut
from apps.nexus_api.dependencies import get_current_user, get_current_agent_by_key, get_password_hash, RequireRole
...
async def checkin_agent(
    ...
    import datetime
    current_agent.last_seen_at = datetime.datetime.now(datetime.timezone.utc)
