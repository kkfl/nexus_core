    ...
    return (
        <div style={pageContainer(t)}>
            ...
            <div style={{ marginBottom: 20 }}>
                <Title level={3} style={{ margin: 0, color: t.text }}><CameraOutlined style={{ marginRight: 10, color: t.accent }} />PBX Snapshots</Title>
                <Text style={{ color: t.muted }}>Read-only view of PBX snapshot history</Text>
            </div>
