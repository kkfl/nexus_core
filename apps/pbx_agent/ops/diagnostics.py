...
from apps.pbx_agent.adapters.ami import (
    check_connectivity, run_ami_command, AmiError, AmiAuthError, AmiTimeoutError
)
...
async def diagnostic_ami_check(host: str, port: int, ami_username: str, ami_secret: str) -> Dict[str, Any]:
    """
