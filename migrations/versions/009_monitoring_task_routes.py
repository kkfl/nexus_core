...
def upgrade() -> None:
    ...
    routes = [
        {
            "task_type": "monitoring.ingest.nagios.statusjson",
            "capabilities": '["monitoring.ingest.nagios.statusjson"]',
        },
        {
            "task_type": "monitoring.ingest.nagios.ndjson",
            "capabilities": '["monitoring.ingest.nagios.ndjson"]',
        },
