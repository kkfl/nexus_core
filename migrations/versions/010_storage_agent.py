...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "access_key_id_secret_id", sa.String(), sa.ForeignKey("secrets.id"), nullable=False
        ),
        sa.Column(
            "secret_access_key_secret_id", sa.String(), sa.ForeignKey("secrets.id"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column(
            "storage_target_id", sa.String(), sa.ForeignKey("storage_targets.id"), nullable=False
        ),
