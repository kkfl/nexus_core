...
def upgrade() -> None:
    ...
    op.create_table('automation_runs',
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(['automation_id'], ['automation_definitions.id'], ondelete='SET NULL'),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('idempotency_key')
    )

    # automation_step_runs
    op.create_table('automation_step_runs',
        sa.Column('id', sa.String(length=36), nullable=False),
    ...
    # automation_dlq
    op.create_table('automation_dlq',
        sa.Column('id', sa.String(length=36), nullable=False),
        sa.Column('run_id', sa.String(length=36), nullable=False),
    ...
    op.create_table('automation_audit_events',
        sa.Column('id', sa.String(length=36), nullable=False),
        sa.Column('correlation_id', sa.String(length=128), nullable=False),
