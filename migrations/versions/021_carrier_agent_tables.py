...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_carrier_targets_tenant_id"), "carrier_targets", ["tenant_id"], unique=False
    )
    op.create_index(op.f("ix_carrier_targets_env"), "carrier_targets", ["env"], unique=False)

    op.create_table(
        "carrier_did_inventory",
        sa.Column("id", sa.String(length=36), nullable=False),
        sa.Column("tenant_id", sa.String(length=100), nullable=False),
        sa.Column("env", sa.String(length=20), nullable=False, server_default="prod"),
    ...
    op.create_index(
        op.f("ix_carrier_did_inventory_tenant_id"),
        "carrier_did_inventory",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_carrier_did_inventory_number"), "carrier_did_inventory", ["number"], unique=False
    )

    op.create_table(
        "carrier_trunk_records",
        sa.Column("id", sa.String(length=36), nullable=False),
        sa.Column("tenant_id", sa.String(length=100), nullable=False),
        sa.Column("env", sa.String(length=20), nullable=False, server_default="prod"),
        sa.Column("carrier_target_id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_carrier_trunk_records_tenant_id"),
        "carrier_trunk_records",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_carrier_jobs_next_retry_at"), "carrier_jobs", ["next_retry_at"], unique=False
    )
    op.create_index(
        op.f("ix_carrier_jobs_correlation_id"), "carrier_jobs", ["correlation_id"], unique=False
    )
    op.create_index(
        op.f("ix_carrier_jobs_idempotency_key"), "carrier_jobs", ["idempotency_key"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_carrier_audit_events_tenant_id"),
        "carrier_audit_events",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_carrier_audit_events_env"), "carrier_audit_events", ["env"], unique=False
    )
    op.create_index(
        op.f("ix_carrier_audit_events_correlation_id"),
        "carrier_audit_events",
        ["correlation_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_carrier_audit_events_timestamp"),
        "carrier_audit_events",
        ["timestamp"],
        unique=False,
    )
