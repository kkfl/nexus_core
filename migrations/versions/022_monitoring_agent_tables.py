...
def upgrade() -> None:
    ...
    op.create_table(
        'monitoring_state',
        sa.Column('target_id', sa.String(), sa.ForeignKey('monitoring_targets.id', ondelete='CASCADE'), primary_key=True),
    ...
    op.create_table(
        'monitoring_checks',
        sa.Column('id', sa.String(), primary_key=True),
        sa.Column('target_id', sa.String(), sa.ForeignKey('monitoring_targets.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('target_id', sa.String(), sa.ForeignKey('monitoring_targets.id', ondelete='SET NULL'), nullable=True),
    ...
    op.create_index('ix_monitoring_audit_events_corr', 'monitoring_audit_events', ['correlation_id'])
